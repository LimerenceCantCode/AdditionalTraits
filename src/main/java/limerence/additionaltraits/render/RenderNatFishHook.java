...
public class RenderNatFishHook extends Render<EntityNatFishHook> {
    ...
    @Override
    public void doRender(EntityNatFishHook entity, double x, double y, double z, float entityYaw, float partialTicks) {
        ...
        if ((entityplayer != null) && (!this.renderOutlines)) {
            ...
            //System.out.println("Hook RENDER position is "+d10+" " +d11+" "+ +d12);
